...
这是 Stage 2 的课程入口。这一章的核心目标是：把系统判断推进成一个高层 LangChain 原型，并从“看懂关键代码”升级到“逐步看懂整个项目”。
...
11. [配套项目目录](../../../03-projects/stage-2/README.md)
...
- 最终不仅要交出结果，还要交出我看懂了什么代码、哪些文件、哪条调用链以及整个项目如何被组织的说明

## 本章在整套课程里的作用

能产出高层原型说明、输出 schema、最小工具清单、主路径讲解，以及对整个项目结构的第一版整体解释。
