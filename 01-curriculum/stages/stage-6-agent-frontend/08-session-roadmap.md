...
2. 随便选 2 个你熟悉的 Agent 想法，判断哪些信息不该只放在聊天流。
3. 让 Codex 帮你纠正对 Agent UX 的误解。
...
2. 用一个真实需求画出最小前端结构。
3. 用 [09-case-comparisons.md](X:/AI%20work/LangChain%20Tutorial/01-curriculum/stages/stage-6-agent-frontend/09-case-comparisons.md) 做对照。
...
2. 产出一张完整前端结构图和一份任务旅程说明。
3. 让 Codex 站在产品体验评审角度做反馈。
